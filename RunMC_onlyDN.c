...
void RunMC_onlyDN(long evt_max, int IsTPBon, int seed, TString evt_type)
{
  ...
  TString filename = "Data/onlyDN_SiPM_"+num+"_"+name_pde+"_"+name_coll_eff+"_"+nSeed+"_"+tpb+"_"+evt_type+".root";
