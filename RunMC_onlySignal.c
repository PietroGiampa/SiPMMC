...
void RunMC_onlySignal(long evt_max, int IsTPBon, int seed, TString evt_type)
{
  ...
  TString filename = "Data/onlySignal_SiPM_"+num+"_"+name_pde+"_"+name_coll_eff+"_"+nSeed+"_"+tpb+"_"+evt_type+".root";
