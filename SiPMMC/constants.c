...
double pde = 0.1; //PDE for the Hamamatsu VUV4 SIPM at 189 nm
...
// set by user
double coll_eff = 1; //detector collection efficiency [%] - light coverage/area coverage of photodetectors
